            ...
            <div className="container my-5">
                <div className="row justify-content-center mx-auto">
                    <div className="col-12 col-md-6">
                        ...
                        <form onSubmit={(e, inputs) => handleSubmit(e, inputs).then((inputs) => registerJobSeeker(inputs)).catch((errors) => setErrors(errors))}>
                            ...
                            <div className="form-group py-1">
                                ...
                                <div class="icon_form">
                                    ...
                                    <input id={errors.includes("Email is required") || errors.includes("Invalid email address") || errors.includes("This email already exist.") ? "error-form" : null} placeholder="john.doe@gmail.com" maxlength="254" type="text" name="email" onChange={handleInputChange} value={inputs.email} />
                            ...
                            <button
                                ...
                                type="submit"
                                onSubmit={(e, inputs) => handleSubmit(e, inputs).then((e, inputs) => registerJobSeeker(e, inputs)).catch((errors) => setErrors(errors))}
                            >
                                SIGN UP
                            </button>
